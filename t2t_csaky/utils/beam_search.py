...
def beam_search(symbols_to_logits_fn,
  ...
  def inner_loop(i, alive_seq, alive_log_probs, finished_seq, finished_scores,
                 finished_flags, states, enc_out=None):
    ...
    topk_seq, topk_log_probs, topk_scores, topk_finished, states, enc_out = \
      grow_topk(
  ...
  (_, alive_seq, alive_log_probs, finished_seq, finished_scores,
   finished_flags, _, enc_out) = tf.while_loop(
       _is_finished,
       inner_loop, [
           tf.constant(0), alive_seq, alive_log_probs, finished_seq,
           finished_scores, finished_flags, states, None
       ],
       shape_invariants=[
           tf.TensorShape([]),
  ...
  return finished_seq, finished_scores, enc_out
